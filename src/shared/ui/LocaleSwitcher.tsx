  ...
  return (
    <div className="relative">
      <button
        ...
        className={`flex gap-3 bg-white rounded-xl border border-stone-600 content-center py-1 px-3 capitalize cursor-pointer ${isActive ? "rounded-b-none border-b-0 " : ""}`}
      >
